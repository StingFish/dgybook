...
<div class="topnav" id="myTopnav" style="background-color: #0a0b5c; border-bottom: 5px solid #a3a3a3;">
  <div>
  <a href="javascript:void(0);" onclick="openNav()"><img src="CvSU/logo-removebg.png" alt="logo" class="logo" style="margin-left: 10px;margin-right: 10px;margin-bottom: 10px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b><?php echo $_SESSION['User']; ?></b></i></a>
</div>
</div>
</header>
<section>
   ...
   <tbody style="border-radius: 10px;">
    ...
    <tr onclick="window.location='storage/Students Database/path.php';">
      <td  style="width:20%">
          ...
          <div class='imgBx' style='border:none;'>
          <img src="CvSU/blue.png" style="width:200px;"></center></td>
      <td style="width:80%;"><b>ALUMNI TABLE</b><br><p align="justify" style="margin-right: 20px;">This is the place where you can input students profile and information. It contains basic information including student ID, full name, quotations, year, and contact information. This database is linked to all of the student's school preferences and the information are easily added by the registrars.</p></td>
    </tr>
    <tr onclick="window.location='storage/Milestones & Activities/path.php';">
      <td  style="width:20%">
          ...
          <div class='imgBx' style='border:none;'>
          <img src="CvSU/blue.png" style="width:200px;"></center></td>
      <td style="width:80%;"><b>MILESTONES TABLE</b><br><p align="justify" style="margin-right: 20px;">This is the place where you can input pictures of every batch. This is where you can add desciptions to post memorable things in digital yearbook.</p></td>
    </tr>
    <tr onclick="window.location='storage/Extras Database/index.php';">
      <td  style="width:20%">
          ...
          <div class='imgBx' style='border:none;'>
          <img src="CvSU/blue.png" style="width:200px;"></center></td>
      <td style="width:80%;"><b>EXTRAS TABLE</b><br><p align="justify" style="margin-right: 20px;">This is the place where you can input title, color scheme, and message of every batch. This is where you can add desciptions to add it in digital yearbook.</p></td>
    </tr>
    <tr onclick="window.location='storage/EYearbook Database/path.php';">
      <td  style="width:20%">
          ...
          <div class='imgBx' style='border:none;'>
          <img src="CvSU/blue.png" style="width:200px;"></center></td>
      <td style="width:80%;"><b>EMPLOYEE'S YEARBOOK TABLE</b><br><p align="justify" style="margin-right: 20px;">This is the place where you can see the employee's overall inputs from the databases. It contains data added from Administrative Officers & Academic Affairs.</p></td>
    </tr>
    <tr onclick="window.location='storage/SYearbook Database/path.php';">
      <td  style="width:20%">
          ...
          <div class='imgBx' style='border:none;'>
          <img src="CvSU/blue.png" style="width:200px;"></center></td>
      <td style="width:80%;"><b>ALUMNI YEARBOOK TABLE</b><br><p align="justify" style="margin-right: 20px;">This is the place where you can see the alumni's overall inputs from the databases. It contains data added from Alumni Graduates.</p></td>
    </tr>
    <tr onclick="window.location='storage/Job Hirings/index.php';">
      <td  style="width:20%">
          ...
          <div class='imgBx' style='border:none;'>
          <img src="CvSU/blue.png" style="width:200px;"></center></td>
      <td style="width:80%;"><b>JOB HIRINGS TABLE</b><br><p align="justify" style="margin-right: 20px;">This is the place where you can input latest updates about the available job hirings on the other company. This may help to students get job easily after graduating.</p></td>
    </tr>
    <tr onclick="window.location='storage/DYearbook/path.php';">
      <td  style="width:20%; padding: -10 -10px ;">
          <center>
          <div class='imgBx' style='border:none;'>
          <img src="CvSU/blue.png" style="width:200px;"></center></td>
      <td style="width:80%;"><b>VIEW ALUMNI YEARBOOK</b><br><p align="justify" style="margin-right: 20px;">This is the place where you can see the digital yearbook you made. It contains yearbook that was grouped by year.</p></td>
    </tr>   
  </tbody>
  </table>
</form>
