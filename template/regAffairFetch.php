...
<select name="type2" id="mylist" class="text" onchange="myFunctions()" style="padding: 15px 35px">
	...
	while($row = mysqli_fetch_array($result))
	{
		$output .= '
			<tr align="center">
				<td align="center" style="word-wrap: break-word" data-label="Course">'.$row["comp_name"].'</td>
				<td align="center" style="word-wrap: break-word" data-label="Category" style="word-wrap: break-word">'.$row["category"].'</td>
				<td align="center" style="word-wrap: break-word" data-label="Job Type" style="word-wrap: break-word">'.$row["jobtype"].'</td>
				<td align="center" style="word-wrap: break-word" data-label="Date Released">'.$row["date_release"].'</td>
        <td data-label="Full Description">
        <button style="background-color:gold">
        <a href="../storage/Job Hirings/uploads/'.$row["filename"].'" style="color:white" target="_blank"><b>View</b></a></button>
        </td>
			</tr>
		';
	}
