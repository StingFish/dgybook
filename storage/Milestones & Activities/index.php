...
<div id="mySidenav" class="sidenav">
  ...
  <p><a class="un" href="../../storage/Milestones & Activities/path.php" style="float: left;font-size: 15px;display: block;color: white;">Milestones Table</a></p>
...
<div>
  <center><input class="inp" type="text" placeholder="Search by Description" name="search-text" style="width:50%;background-position: 10px 10px;padding: 10px 20px 10px 35px;margin-bottom: 5px;margin-top: 5px;" id="search_text_affair"></center>
</div>
</div>
<br>
<br>
